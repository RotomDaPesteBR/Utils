namespace LightningArc.Mappers.Mapster.Adapters;

/// <summary>
/// Adapter implementation of <see cref="LightningArc.Data.Abstractions.Mappers.IMapper"/> using the Mapster library.
/// </summary>
